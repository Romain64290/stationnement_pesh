...
?>		
		...
		<div class="container">
			<img src="img/ppp.png">
			<b><h3>Compostage individuel
			<br>
			Nourrissez votre jardin, pas votre poubelle !</h3>
			<h3 style="color:#808000"> CHARTE D'ENGAGEMENT
			<br>
			A la pratique du compostage
			<br>
			</h3></b> <h3 style="text-align:left"><b>En valorisant mes déchets organiques :</b></h3>
			<ul>
				<li>
			...
			<ul>
				<li>
			<b>Utiliser</b> exclusivement ce composteur dans son jardin, sur le territoire de la Communauté d'Agglomération de Pau-Pyrénées afin de permettre le recyclage des bio déchets, ainsi que, dans une petite mesure, des déchets de jardin selon les recommandations préconisées lors de la formation.
			</li>
				</ul>	
				<ul>
			<li><b>Répondre</b> aux demandes éventuelles de la Communauté d'Agglomération Pau-Pyrénées, concernant la performance du composteur et les difficultés éventuelles rencontrées lors de son utilisation.
			</li>
